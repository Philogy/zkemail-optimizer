...
contract SimplifiedVerifier {
    function verify(uint256 pubInput, bytes calldata proof) external view returns (bool) {
        ...
        assembly {
            ...
            {
                let x := calldataload(add(proof.offset, 0x00))
                mstore(add(transcript, 0x40), x)
                let y := calldataload(add(proof.offset, 0x20))
                mstore(add(transcript, 0x60), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x40))
                mstore(add(transcript, 0x80), x)
                let y := calldataload(add(proof.offset, 0x60))
                mstore(add(transcript, 0xa0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x80))
                mstore(add(transcript, 0xc0), x)
                let y := calldataload(add(proof.offset, 0xa0))
                mstore(add(transcript, 0xe0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xc0))
                mstore(add(transcript, 0x100), x)
                let y := calldataload(add(proof.offset, 0xe0))
                mstore(add(transcript, 0x120), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x100))
                mstore(add(transcript, 0x140), x)
                let y := calldataload(add(proof.offset, 0x120))
                mstore(add(transcript, 0x160), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x140))
                mstore(add(transcript, 0x180), x)
                let y := calldataload(add(proof.offset, 0x160))
                mstore(add(transcript, 0x1a0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x180))
                mstore(add(transcript, 0x1c0), x)
                let y := calldataload(add(proof.offset, 0x1a0))
                mstore(add(transcript, 0x1e0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1c0))
                mstore(add(transcript, 0x200), x)
                let y := calldataload(add(proof.offset, 0x1e0))
                mstore(add(transcript, 0x220), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x200))
                mstore(add(transcript, 0x240), x)
                let y := calldataload(add(proof.offset, 0x220))
                mstore(add(transcript, 0x260), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x240))
                mstore(add(transcript, 0x280), x)
                let y := calldataload(add(proof.offset, 0x260))
                mstore(add(transcript, 0x2a0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x280))
                mstore(add(transcript, 0x2c0), x)
                let y := calldataload(add(proof.offset, 0x2a0))
                mstore(add(transcript, 0x2e0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x2c0))
                mstore(add(transcript, 0x300), x)
                let y := calldataload(add(proof.offset, 0x2e0))
                mstore(add(transcript, 0x320), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x300))
                mstore(add(transcript, 0x340), x)
                let y := calldataload(add(proof.offset, 0x320))
                mstore(add(transcript, 0x360), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x340))
                mstore(add(transcript, 0x380), x)
                let y := calldataload(add(proof.offset, 0x360))
                mstore(add(transcript, 0x3a0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x380))
                mstore(add(transcript, 0x3c0), x)
                let y := calldataload(add(proof.offset, 0x3a0))
                mstore(add(transcript, 0x3e0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x3c0))
                mstore(add(transcript, 0x400), x)
                let y := calldataload(add(proof.offset, 0x3e0))
                mstore(add(transcript, 0x420), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x400))
                mstore(add(transcript, 0x440), x)
                let y := calldataload(add(proof.offset, 0x420))
                mstore(add(transcript, 0x460), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x440))
                mstore(add(transcript, 0x480), x)
                let y := calldataload(add(proof.offset, 0x460))
                mstore(add(transcript, 0x4a0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x480))
                mstore(add(transcript, 0x4c0), x)
                let y := calldataload(add(proof.offset, 0x4a0))
                mstore(add(transcript, 0x4e0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x4c0))
                mstore(add(transcript, 0x500), x)
                let y := calldataload(add(proof.offset, 0x4e0))
                mstore(add(transcript, 0x520), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x500))
                mstore(add(transcript, 0x540), x)
                let y := calldataload(add(proof.offset, 0x520))
                mstore(add(transcript, 0x560), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x540))
                mstore(add(transcript, 0x580), x)
                let y := calldataload(add(proof.offset, 0x560))
                mstore(add(transcript, 0x5a0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x580))
                mstore(add(transcript, 0x5c0), x)
                let y := calldataload(add(proof.offset, 0x5a0))
                mstore(add(transcript, 0x5e0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x5c0))
                mstore(add(transcript, 0x600), x)
                let y := calldataload(add(proof.offset, 0x5e0))
                mstore(add(transcript, 0x620), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x600))
                mstore(add(transcript, 0x640), x)
                let y := calldataload(add(proof.offset, 0x620))
                mstore(add(transcript, 0x660), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x640))
                mstore(add(transcript, 0x680), x)
                let y := calldataload(add(proof.offset, 0x660))
                mstore(add(transcript, 0x6a0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x680))
                mstore(add(transcript, 0x6c0), x)
                let y := calldataload(add(proof.offset, 0x6a0))
                mstore(add(transcript, 0x6e0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x6c0))
                mstore(add(transcript, 0x700), x)
                let y := calldataload(add(proof.offset, 0x6e0))
                mstore(add(transcript, 0x720), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x700))
                mstore(add(transcript, 0x740), x)
                let y := calldataload(add(proof.offset, 0x720))
                mstore(add(transcript, 0x760), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x740))
                mstore(add(transcript, 0x780), x)
                let y := calldataload(add(proof.offset, 0x760))
                mstore(add(transcript, 0x7a0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x780))
                mstore(add(transcript, 0x7c0), x)
                let y := calldataload(add(proof.offset, 0x7a0))
                mstore(add(transcript, 0x7e0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x7c0))
                mstore(add(transcript, 0x800), x)
                let y := calldataload(add(proof.offset, 0x7e0))
                mstore(add(transcript, 0x820), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x800))
                mstore(add(transcript, 0x840), x)
                let y := calldataload(add(proof.offset, 0x820))
                mstore(add(transcript, 0x860), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x840))
                mstore(add(transcript, 0x880), x)
                let y := calldataload(add(proof.offset, 0x860))
                mstore(add(transcript, 0x8a0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x880))
                mstore(add(transcript, 0x8c0), x)
                let y := calldataload(add(proof.offset, 0x8a0))
                mstore(add(transcript, 0x8e0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x8c0))
                mstore(add(transcript, 0x900), x)
                let y := calldataload(add(proof.offset, 0x8e0))
                mstore(add(transcript, 0x920), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x900))
                mstore(add(transcript, 0x940), x)
                let y := calldataload(add(proof.offset, 0x920))
                mstore(add(transcript, 0x960), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x940))
                mstore(add(transcript, 0x980), x)
                let y := calldataload(add(proof.offset, 0x960))
                mstore(add(transcript, 0x9a0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x980))
                mstore(add(transcript, 0x9c0), x)
                let y := calldataload(add(proof.offset, 0x9a0))
                mstore(add(transcript, 0x9e0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x9c0))
                mstore(add(transcript, 0xa00), x)
                let y := calldataload(add(proof.offset, 0x9e0))
                mstore(add(transcript, 0xa20), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xa00))
                mstore(add(transcript, 0xa40), x)
                let y := calldataload(add(proof.offset, 0xa20))
                mstore(add(transcript, 0xa60), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xa40))
                mstore(add(transcript, 0xa80), x)
                let y := calldataload(add(proof.offset, 0xa60))
                mstore(add(transcript, 0xaa0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xa80))
                mstore(add(transcript, 0xac0), x)
                let y := calldataload(add(proof.offset, 0xaa0))
                mstore(add(transcript, 0xae0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xac0))
                mstore(add(transcript, 0xb00), x)
                let y := calldataload(add(proof.offset, 0xae0))
                mstore(add(transcript, 0xb20), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xb00))
                mstore(add(transcript, 0xb40), x)
                let y := calldataload(add(proof.offset, 0xb20))
                mstore(add(transcript, 0xb60), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xb40))
                mstore(add(transcript, 0xb80), x)
                let y := calldataload(add(proof.offset, 0xb60))
                mstore(add(transcript, 0xba0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xb80))
                mstore(add(transcript, 0xbc0), x)
                let y := calldataload(add(proof.offset, 0xba0))
                mstore(add(transcript, 0xbe0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xbc0))
                mstore(add(transcript, 0xc00), x)
                let y := calldataload(add(proof.offset, 0xbe0))
                mstore(add(transcript, 0xc20), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xc00))
                mstore(add(transcript, 0xc40), x)
                let y := calldataload(add(proof.offset, 0xc20))
                mstore(add(transcript, 0xc60), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xc40))
                mstore(add(transcript, 0xc80), x)
                let y := calldataload(add(proof.offset, 0xc60))
                mstore(add(transcript, 0xca0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xc80))
                mstore(add(transcript, 0xcc0), x)
                let y := calldataload(add(proof.offset, 0xca0))
                mstore(add(transcript, 0xce0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xcc0))
                mstore(add(transcript, 0xd00), x)
                let y := calldataload(add(proof.offset, 0xce0))
                mstore(add(transcript, 0xd20), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xd00))
                mstore(add(transcript, 0xd40), x)
                let y := calldataload(add(proof.offset, 0xd20))
            ...
            {
                let x := calldataload(add(proof.offset, 0xd40))
                mstore(add(transcript, 0xde0), x)
                let y := calldataload(add(proof.offset, 0xd60))
                mstore(add(transcript, 0xe00), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xd80))
                mstore(add(transcript, 0xe20), x)
                let y := calldataload(add(proof.offset, 0xda0))
                mstore(add(transcript, 0xe40), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xdc0))
                mstore(add(transcript, 0xe60), x)
                let y := calldataload(add(proof.offset, 0xde0))
                mstore(add(transcript, 0xe80), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xe00))
                mstore(add(transcript, 0xea0), x)
                let y := calldataload(add(proof.offset, 0xe20))
                mstore(add(transcript, 0xec0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xe40))
                mstore(add(transcript, 0xee0), x)
                let y := calldataload(add(proof.offset, 0xe60))
                mstore(add(transcript, 0xf00), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xe80))
                mstore(add(transcript, 0xf20), x)
                let y := calldataload(add(proof.offset, 0xea0))
                mstore(add(transcript, 0xf40), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xec0))
                mstore(add(transcript, 0xf60), x)
                let y := calldataload(add(proof.offset, 0xee0))
                mstore(add(transcript, 0xf80), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xf00))
                mstore(add(transcript, 0xfa0), x)
                let y := calldataload(add(proof.offset, 0xf20))
                mstore(add(transcript, 0xfc0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xf40))
                mstore(add(transcript, 0xfe0), x)
                let y := calldataload(add(proof.offset, 0xf60))
                mstore(add(transcript, 0x1000), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xf80))
                mstore(add(transcript, 0x1020), x)
                let y := calldataload(add(proof.offset, 0xfa0))
                mstore(add(transcript, 0x1040), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0xfc0))
                mstore(add(transcript, 0x1060), x)
                let y := calldataload(add(proof.offset, 0xfe0))
                mstore(add(transcript, 0x1080), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1000))
                mstore(add(transcript, 0x10a0), x)
                let y := calldataload(add(proof.offset, 0x1020))
                mstore(add(transcript, 0x10c0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1040))
                mstore(add(transcript, 0x10e0), x)
                let y := calldataload(add(proof.offset, 0x1060))
                mstore(add(transcript, 0x1100), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1080))
                mstore(add(transcript, 0x1120), x)
                let y := calldataload(add(proof.offset, 0x10a0))
                mstore(add(transcript, 0x1140), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x10c0))
                mstore(add(transcript, 0x1160), x)
                let y := calldataload(add(proof.offset, 0x10e0))
                mstore(add(transcript, 0x1180), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1100))
                mstore(add(transcript, 0x11a0), x)
                let y := calldataload(add(proof.offset, 0x1120))
                mstore(add(transcript, 0x11c0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1140))
                mstore(add(transcript, 0x11e0), x)
                let y := calldataload(add(proof.offset, 0x1160))
                mstore(add(transcript, 0x1200), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1180))
                mstore(add(transcript, 0x1220), x)
                let y := calldataload(add(proof.offset, 0x11a0))
                mstore(add(transcript, 0x1240), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x11c0))
                mstore(add(transcript, 0x1260), x)
                let y := calldataload(add(proof.offset, 0x11e0))
                mstore(add(transcript, 0x1280), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1200))
                mstore(add(transcript, 0x12a0), x)
                let y := calldataload(add(proof.offset, 0x1220))
                mstore(add(transcript, 0x12c0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1240))
                mstore(add(transcript, 0x12e0), x)
                let y := calldataload(add(proof.offset, 0x1260))
                mstore(add(transcript, 0x1300), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1280))
                mstore(add(transcript, 0x1320), x)
                let y := calldataload(add(proof.offset, 0x12a0))
                mstore(add(transcript, 0x1340), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x12c0))
                mstore(add(transcript, 0x1360), x)
                let y := calldataload(add(proof.offset, 0x12e0))
                mstore(add(transcript, 0x1380), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1300))
                mstore(add(transcript, 0x13a0), x)
                let y := calldataload(add(proof.offset, 0x1320))
                mstore(add(transcript, 0x13c0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1340))
                mstore(add(transcript, 0x13e0), x)
                let y := calldataload(add(proof.offset, 0x1360))
                mstore(add(transcript, 0x1400), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1380))
                mstore(add(transcript, 0x1420), x)
                let y := calldataload(add(proof.offset, 0x13a0))
                mstore(add(transcript, 0x1440), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x13c0))
                mstore(add(transcript, 0x1460), x)
                let y := calldataload(add(proof.offset, 0x13e0))
                mstore(add(transcript, 0x1480), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1400))
                mstore(add(transcript, 0x14a0), x)
                let y := calldataload(add(proof.offset, 0x1420))
                mstore(add(transcript, 0x14c0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1440))
                mstore(add(transcript, 0x14e0), x)
                let y := calldataload(add(proof.offset, 0x1460))
                mstore(add(transcript, 0x1500), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1480))
                mstore(add(transcript, 0x1520), x)
                let y := calldataload(add(proof.offset, 0x14a0))
                mstore(add(transcript, 0x1540), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x14c0))
                mstore(add(transcript, 0x1560), x)
                let y := calldataload(add(proof.offset, 0x14e0))
                mstore(add(transcript, 0x1580), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1500))
                mstore(add(transcript, 0x15a0), x)
                let y := calldataload(add(proof.offset, 0x1520))
                mstore(add(transcript, 0x15c0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1540))
                mstore(add(transcript, 0x15e0), x)
                let y := calldataload(add(proof.offset, 0x1560))
                mstore(add(transcript, 0x1600), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1580))
                mstore(add(transcript, 0x1620), x)
                let y := calldataload(add(proof.offset, 0x15a0))
                mstore(add(transcript, 0x1640), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x15c0))
                mstore(add(transcript, 0x1660), x)
                let y := calldataload(add(proof.offset, 0x15e0))
                mstore(add(transcript, 0x1680), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1600))
                mstore(add(transcript, 0x16a0), x)
                let y := calldataload(add(proof.offset, 0x1620))
                mstore(add(transcript, 0x16c0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1640))
                mstore(add(transcript, 0x16e0), x)
                let y := calldataload(add(proof.offset, 0x1660))
                mstore(add(transcript, 0x1700), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1680))
                mstore(add(transcript, 0x1720), x)
                let y := calldataload(add(proof.offset, 0x16a0))
                mstore(add(transcript, 0x1740), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x16c0))
                mstore(add(transcript, 0x1760), x)
                let y := calldataload(add(proof.offset, 0x16e0))
                mstore(add(transcript, 0x1780), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1700))
                mstore(add(transcript, 0x17a0), x)
                let y := calldataload(add(proof.offset, 0x1720))
                mstore(add(transcript, 0x17c0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1740))
                mstore(add(transcript, 0x17e0), x)
                let y := calldataload(add(proof.offset, 0x1760))
                mstore(add(transcript, 0x1800), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1780))
                mstore(add(transcript, 0x1820), x)
                let y := calldataload(add(proof.offset, 0x17a0))
                mstore(add(transcript, 0x1840), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x17c0))
                mstore(add(transcript, 0x1860), x)
                let y := calldataload(add(proof.offset, 0x17e0))
                mstore(add(transcript, 0x1880), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1800))
                mstore(add(transcript, 0x18a0), x)
                let y := calldataload(add(proof.offset, 0x1820))
            ...
            {
                let x := calldataload(add(proof.offset, 0x1840))
                mstore(add(transcript, 0x19a0), x)
                let y := calldataload(add(proof.offset, 0x1860))
                mstore(add(transcript, 0x19c0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1880))
                mstore(add(transcript, 0x19e0), x)
                let y := calldataload(add(proof.offset, 0x18a0))
                mstore(add(transcript, 0x1a00), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x18c0))
                mstore(add(transcript, 0x1a20), x)
                let y := calldataload(add(proof.offset, 0x18e0))
                mstore(add(transcript, 0x1a40), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1900))
                mstore(add(transcript, 0x1a60), x)
                let y := calldataload(add(proof.offset, 0x1920))
                mstore(add(transcript, 0x1a80), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1940))
                mstore(add(transcript, 0x1aa0), x)
                let y := calldataload(add(proof.offset, 0x1960))
                mstore(add(transcript, 0x1ac0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1980))
                mstore(add(transcript, 0x1ae0), x)
                let y := calldataload(add(proof.offset, 0x19a0))
                mstore(add(transcript, 0x1b00), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x19c0))
                mstore(add(transcript, 0x1b20), x)
                let y := calldataload(add(proof.offset, 0x19e0))
                mstore(add(transcript, 0x1b40), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1a00))
                mstore(add(transcript, 0x1b60), x)
                let y := calldataload(add(proof.offset, 0x1a20))
                mstore(add(transcript, 0x1b80), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1a40))
                mstore(add(transcript, 0x1ba0), x)
                let y := calldataload(add(proof.offset, 0x1a60))
                mstore(add(transcript, 0x1bc0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1a80))
                mstore(add(transcript, 0x1be0), x)
                let y := calldataload(add(proof.offset, 0x1aa0))
                mstore(add(transcript, 0x1c00), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1ac0))
                mstore(add(transcript, 0x1c20), x)
                let y := calldataload(add(proof.offset, 0x1ae0))
                mstore(add(transcript, 0x1c40), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1b00))
                mstore(add(transcript, 0x1c60), x)
                let y := calldataload(add(proof.offset, 0x1b20))
                mstore(add(transcript, 0x1c80), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1b40))
                mstore(add(transcript, 0x1ca0), x)
                let y := calldataload(add(proof.offset, 0x1b60))
                mstore(add(transcript, 0x1cc0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1b80))
                mstore(add(transcript, 0x1ce0), x)
                let y := calldataload(add(proof.offset, 0x1ba0))
                mstore(add(transcript, 0x1d00), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1bc0))
                mstore(add(transcript, 0x1d20), x)
                let y := calldataload(add(proof.offset, 0x1be0))
                mstore(add(transcript, 0x1d40), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1c00))
                mstore(add(transcript, 0x1d60), x)
                let y := calldataload(add(proof.offset, 0x1c20))
                mstore(add(transcript, 0x1d80), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1c40))
                mstore(add(transcript, 0x1da0), x)
                let y := calldataload(add(proof.offset, 0x1c60))
                mstore(add(transcript, 0x1dc0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1c80))
                mstore(add(transcript, 0x1de0), x)
                let y := calldataload(add(proof.offset, 0x1ca0))
                mstore(add(transcript, 0x1e00), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1cc0))
                mstore(add(transcript, 0x1e20), x)
                let y := calldataload(add(proof.offset, 0x1ce0))
                mstore(add(transcript, 0x1e40), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1d00))
                mstore(add(transcript, 0x1e60), x)
                let y := calldataload(add(proof.offset, 0x1d20))
                mstore(add(transcript, 0x1e80), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1d40))
                mstore(add(transcript, 0x1ea0), x)
                let y := calldataload(add(proof.offset, 0x1d60))
                mstore(add(transcript, 0x1ec0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1d80))
                mstore(add(transcript, 0x1ee0), x)
                let y := calldataload(add(proof.offset, 0x1da0))
                mstore(add(transcript, 0x1f00), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1dc0))
                mstore(add(transcript, 0x1f20), x)
                let y := calldataload(add(proof.offset, 0x1de0))
                mstore(add(transcript, 0x1f40), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1e00))
                mstore(add(transcript, 0x1f60), x)
                let y := calldataload(add(proof.offset, 0x1e20))
                mstore(add(transcript, 0x1f80), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1e40))
                mstore(add(transcript, 0x1fa0), x)
                let y := calldataload(add(proof.offset, 0x1e60))
                mstore(add(transcript, 0x1fc0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1e80))
                mstore(add(transcript, 0x1fe0), x)
                let y := calldataload(add(proof.offset, 0x1ea0))
                mstore(add(transcript, 0x2000), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1ec0))
                mstore(add(transcript, 0x2020), x)
                let y := calldataload(add(proof.offset, 0x1ee0))
                mstore(add(transcript, 0x2040), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1f00))
                mstore(add(transcript, 0x2060), x)
                let y := calldataload(add(proof.offset, 0x1f20))
                mstore(add(transcript, 0x2080), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1f40))
                mstore(add(transcript, 0x20a0), x)
                let y := calldataload(add(proof.offset, 0x1f60))
                mstore(add(transcript, 0x20c0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1f80))
                mstore(add(transcript, 0x20e0), x)
                let y := calldataload(add(proof.offset, 0x1fa0))
                mstore(add(transcript, 0x2100), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x1fc0))
                mstore(add(transcript, 0x2120), x)
                let y := calldataload(add(proof.offset, 0x1fe0))
                mstore(add(transcript, 0x2140), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x2000))
                mstore(add(transcript, 0x2160), x)
                let y := calldataload(add(proof.offset, 0x2020))
                mstore(add(transcript, 0x2180), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x2040))
                mstore(add(transcript, 0x21a0), x)
                let y := calldataload(add(proof.offset, 0x2060))
                mstore(add(transcript, 0x21c0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x2080))
                mstore(add(transcript, 0x21e0), x)
                let y := calldataload(add(proof.offset, 0x20a0))
                mstore(add(transcript, 0x2200), y)
                success := and(validate_ec_point(x, y), success)
            }
            ...
            {
                let x := calldataload(add(proof.offset, 0x20c0))
                mstore(add(transcript, 0x2280), x)
                let y := calldataload(add(proof.offset, 0x20e0))
                mstore(add(transcript, 0x22a0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x2100))
                mstore(add(transcript, 0x22c0), x)
                let y := calldataload(add(proof.offset, 0x2120))
                mstore(add(transcript, 0x22e0), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x2140))
                mstore(add(transcript, 0x2300), x)
                let y := calldataload(add(proof.offset, 0x2160))
                mstore(add(transcript, 0x2320), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x2180))
                mstore(add(transcript, 0x2340), x)
                let y := calldataload(add(proof.offset, 0x21a0))
                mstore(add(transcript, 0x2360), y)
                success := and(validate_ec_point(x, y), success)
            }
            {
                let x := calldataload(add(proof.offset, 0x21c0))
                mstore(add(transcript, 0x2380), x)
                let y := calldataload(add(proof.offset, 0x21e0))
                mstore(add(transcript, 0x23a0), y)
                success := and(validate_ec_point(x, y), success)
            }
            ...
            {
                let x := calldataload(add(proof.offset, 0x5120))
                mstore(add(transcript, 0x5400), x)
                let y := calldataload(add(proof.offset, 0x5140))
                mstore(add(transcript, 0x5420), y)
                success := and(validate_ec_point(x, y), success)
            }
            ...
            {
                let x := calldataload(add(proof.offset, 0x5160))
                mstore(add(transcript, 0x54a0), x)
                let y := calldataload(add(proof.offset, 0x5180))
                mstore(add(transcript, 0x54c0), y)
                success := and(validate_ec_point(x, y), success)
            }
